...
def get_phrase_matches(sample, keywords):
...
student_essay = "It changed the lives of the Taino because of Columbus came there to take over there village and the Taino's chiefs died and people starved."

student_sample = nlp(student_essay)
...
transitions = ["Thus", "for example", "for instance", "namely", "to illustrate", "in other words", "in particular",
"specifically", "such as", "for example", "for instance", "as an illustration", "On the contrary", "contrarily", "notwithstanding", "but", "however", "nevertheless", "in spite of",
                        "in contrast", "yet", "on one hand", "on the other hand", "rather", "or", "nor", "conversely", "at the same time", 
                        "while this may be true", "as can be seen", "generally speaking", "in the final analysis", 
  "all things considered", "as shown above", "in the long run", "given these points", 
  "as has been noted", "in a word", "for the most part", "after all", "in fact", 
  "in summary", "in conclusion", "in short", "in brief", "in essence", 
  "to summarize", "on balance", "altogether", "overall", "ordinarily", "usually", 
